...
import com.example.CarSale.Services.AppUserDetailsService;
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests.
                                        ...
                                        requestMatchers("/", "/users/login", "/users/register", "/users/login-error", "/users/{username}", "/brands/**", "/offers/**", "/img/*", "/OffersImg/*")
                                        .permitAll().
